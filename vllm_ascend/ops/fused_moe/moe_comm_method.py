...
class FusedMC2CommImpl(MoECommMethod):
    ...
    def __init__(self, moe_config):
        ...
        self._mega_moe_symm_buffer = lambda *args, **kwargs: None
        self._mega_moe_weight_type = lambda *args, **kwargs: None
    ...
    def _apply_cann_mega_moe(
        ...
        if self.mega_moe is None:
            self._load_mega_moe_ops()
